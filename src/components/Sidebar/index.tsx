...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      // },
      {
        ...
        label: "Institutes/Collages",
        route: "",
        children: [
          { label: "All Institutes", route: "/institutes/all_institutes" },
          { label: "New Institutes", route: "/institutes/new_institutes" }, 
          { label: "Recycle Bin", route: "" }
        ],
      },
      {
        icon: (
