...
import { newInstitutes as localInstitutes } from "@/tempdata/insdata"; // Fallback data

const API_URL = "/api/v1/"; // Replace with actual API
...
const NewInstitutes = () => {
  ...
  return (
    ...
    <div className="mx-auto max-w-full">
      ...
      <div>
        <Breadcrumb pageName="New Institutes/Colleges" />
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-6">
          {institutes.map((institute, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex justify-center items-center space-x-4 opacity-0 group-hover:opacity-100 bg-black bg-opacity-50 transition-opacity duration-300 rounded-lg">
